...
public final class SharedPrefHelper {
    ...
    public static final String FAB_POSITION_X="position_x";
    public static final String FAB_POSITION_Y="position_y";
    ...
    public static SharedPreferences getPreferences() {
        return HomeApplianceApp.getAppContext().getSharedPreferences("automationdemo", Context.MODE_PRIVATE);
    }
